...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetgit.Api.Filters;
using dotnetgit.Business.Installer;

namespace dotnetgit.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetgit API", Version = version + "-" + branch});
            });
